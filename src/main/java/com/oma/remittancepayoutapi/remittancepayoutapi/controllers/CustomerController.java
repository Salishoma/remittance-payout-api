...
public class CustomerController {
    ...
    public ResponseEntity<CustomerValidateResponse> validateCustomer(
            @RequestBody @Valid CustomerValidateRequest customerValidateRequest
    ) {
        ...
        return customerValidateResponseResponseEntity;
    }
}
